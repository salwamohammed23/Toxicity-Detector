...
def detailed_analysis(text, max_length=256):
...
if submitted and (content or (input_type == "Text" and content.strip())):
    with st.spinner("Analyzing content..."):
        try:
            ...
            # Stage 3: Detailed analysis (if enabled)
            if detailed:
                ...
                if confidence > threshold:
                    ...
                    **Most Likely Category**: {label['name']}  
                ...
                st.success("## ✅ Content Passed Safety Check")
                st.info("Detailed analysis was not requested.")
